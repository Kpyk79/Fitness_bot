...
async def analyze_client_data(user_data: tuple, metrics_history: list, daily_reports: list) -> str:
    ...
    try:
        ...
        # Build context
        context = f"""Ти - професійний фітнес-тренер та дієтолог. Проаналізуй дані клієнта та надай детальні рекомендації українською мовою. Не вітайся.
...
Будь конкретним, мотивуючим та професійним. Максимум 200 слів.
"""
